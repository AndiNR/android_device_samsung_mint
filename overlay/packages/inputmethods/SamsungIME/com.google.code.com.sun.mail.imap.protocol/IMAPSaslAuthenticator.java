 ...
 */
/*Samsung, srinu.siddi@samsung.com elects to include this software in this distribution under the BSD license."*/
/*Samsung, srinu.siddi@samsung.com modified lines 54-62"*/
/*Samsung, srinu.siddi@samsung.com modified lines 154-161"*/
...
import com.google.code.com.sun.mail.imap.protocol.SaslAuthenticator;
...
import com.diotek.ime.framework.connect.gmail.XoauthSaslClientFactory;
...
//	try {
	    sc = new XoauthSaslClientFactory().createSaslClient(mechs, authzid, name, host, (Map)props, cbh);
